...
(() => {
  ...
  const entries = [...(window.__FigmaCNLegacyEntries || []),
    ...
    ['Plus darker', '加深'], ['Plus lighter', '减淡'], ['Layout', '布局'], ['Dimensions', '尺寸'], ['Appearance', '外观'], ['Flow', '流动布局'], ['Scroll behavior', '滚动行为'], ['Scroll with parent', '随父级滚动'], ['Fixed (stay in place)', '固定（保持位置）'], ['Sticky (stop at top edge)', '吸附（停在顶部边缘）'], ['Inner shadow', '内阴影'], ['Drop shadow', '投影'], ['Layer blur', '图层模糊'], ['Background blur', '背景模糊'], ['Noise', '噪点'], ['Texture', '纹理'], ['Glass', '玻璃'], ['Shader', '着色器'], ['Layout guide', '布局参考线'], ['Rows (0px)', '行（0 像素）'], ['Selected colors', '选中的颜色'],
